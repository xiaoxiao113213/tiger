...
import { projectPermissionGetApi, projectPermissionUpdateApi } from '@/pages/project/project/api.tsx';
import { bizTypeEnum } from '@/pages/system/account/ApiBo.ts';

const AccountSetting = (props: { bizType: bizTypeEnum, bizTypeId: number, closeFn: () => void }) => {
  ...
  const initData = async () => {
    ...
    projectPermissionGetApi({ bizType: props.bizType, bizTypeId: props.bizTypeId }).then(rst => {
  ...
  const save = async () => {
    ...
    await projectPermissionUpdateApi({ ...values, bizType: props.bizType, bizTypeId: props.bizTypeId });
