...
const SelectGroupUser = (props: {
  selectedUsers: AccountCacheVo[],
  setSelectedUsers: (selectedUsers: AccountCacheVo[]) => void,
//   排除的用户列表
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', height: '700px', borderRadius: '10px', border: '1px solid #cccccc' }}>
        <div style={{ flex: 1, borderRight: '1px solid #cccccc', borderRadius: '10px', backgroundColor: 'whitesmoke', padding: '3px' }}>
        ...
        <div style={{ flex: 1, borderRadius: '10px', backgroundColor: 'whitesmoke' }}>
          <List
            itemLayout="horizontal"
