...
import ApprovalNodeEdit from '@/pages/flow/process/process/edit/ApprovalNodeEdit.tsx';


function ApprovalNode({ id, data, isConnectable }) {
  ...
  return (
    <div className="text-updater-node" style={{ backgroundColor: '#c7e8a9' }}>
      ...
      <div className="nodrag" style={{ width: 150 }}>
        <div>
          ...
          <label htmlFor="text" style={{ height: 15, fontSize: 15, display: 'flex' }}>
            <span style={{ flex: 1, color: 'blue' }}>设置审批人</span>
            <span style={{ flex: 1, textAlign: 'right' }}>
                        <RightCircleTwoTone
                          onClick={() => {
      ...
      >
        <div>
          <ApprovalNodeEdit processPointId={id} closeSelf={() => {
