...
import { getUserInfoN } from '@/store/userStore';
...
export default function Nav(props: Props) {
  ...
  const permissionRoutes = usePermissionRoutes(userInfo?.permissions, 'nav.tsx');
  ...
  return (
    ...
    >
      <div className="relative flex h-20  py-4">
        <MotionContainer className="flex items-center">
          {/*<Logo />*/}
          <a href={'/'}>
            <img src="/tiger.svg" alt="Logo" id="logo" width={50} height={50} />
          </a>
