...
import { HEADER_HEIGHT, MULTI_TABS_HEIGHT, NAV_COLLAPSED_WIDTH, NAV_HORIZONTAL_HEIGHT, NAV_WIDTH, OFFSET_HEADER_HEIGHT } from './config';
  ...
  const SpecialTabRenderMap: Record<string, (tab: KeepAliveTab) => ReactNode> = useMemo(
    () => ({
      'sys.menu.system.user_detail': (tab: KeepAliveTab) => {
        ...
        const defaultLabel = tab.labelName;
        // if (userId) {
